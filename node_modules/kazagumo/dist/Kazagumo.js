...
const KazagumoPlayer_1 = __importDefault(require("./Managers/KazagumoPlayer"));
const KazagumoTrack_1 = __importDefault(require("./Managers/Supports/KazagumoTrack"));
class Kazagumo extends events_1.EventEmitter {
    ...
    createPlayer(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const kazagumoPlayer = new ((_b = (_a = this.KazagumoOptions.extends) === null || _a === void 0 ? void 0 : _a.player) !== null && _b !== void 0 ? _b : KazagumoPlayer_1.default)(this, shoukakuPlayer, {
                guildId: options.guildId,
    ...
    search(query, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (result.playlistInfo.name)
                loadType = 'PLAYLIST';
            return this.buildSearch((_a = result.playlistInfo.name) !== null && _a !== void 0 ? _a : undefined, result.tracks.map((track) => new KazagumoTrack_1.default(track, options === null || options === void 0 ? void 0 : options.requester)), loadType);
        });
    }
