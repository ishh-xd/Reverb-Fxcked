...
const KazagumoTrack_1 = __importDefault(require("./KazagumoTrack"));
...
class KazagumoQueue extends Array {
     ...
     */
    add(track) {
        if (Array.isArray(track) && track.some((t) => !(t instanceof KazagumoTrack_1.default)))
            throw new Interfaces_1.KazagumoError(1, 'Track must be an instance of KazagumoTrack');
        if (!Array.isArray(track) && !(track instanceof KazagumoTrack_1.default))
            track = [track];
        if (!this.current) {
