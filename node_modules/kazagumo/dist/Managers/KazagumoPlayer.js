...
const KazagumoTrack_1 = __importDefault(require("./Supports/KazagumoTrack"));
class KazagumoPlayer {
    ...
    play(track, options) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.state === Interfaces_1.PlayerState.DESTROYED)
                throw new Interfaces_1.KazagumoError(1, 'Player is already destroyed');
            if (track && !(track instanceof KazagumoTrack_1.default))
            ...
            let errorMessage;
            const resolveResult = yield current.resolve().catch((e) => {
            ...
            if (!resolveResult) {
                ...
                this.queue.current = null;
                this.queue.size ? this.play() : this.emit(Interfaces_1.Events.PlayerEmpty, this);
                return this;
            }
...
exports.default = KazagumoPlayer;
